                                ...
                                <form action="{{route('product.store')}}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control  @error('kode') is-invalid @enderror"
                                            value="{{old('kode')}}" name="kode" autofocus>
                                        @error('kode')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control  @error('stock') is-invalid @enderror"
                                            value="{{old('stock')}}" name="stock" autofocus>
                                        @error('stock')
                                        <div class="alert alert-danger">{{$message}} </div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control  @error('varian') is-invalid @enderror"
                                            value="{{old('varian')}}" name="varian" autofocus>
                                        @error('varian')
                                        <div class="alert alert-danger">{{$message}} </div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{old('keterangan')}}" name="keterangan" autofocus>
                                        @error('keterangan')
                                        <div class="alert alert-danger">{{$message}} </div>
                                        @enderror
                                    </div>
